    ...
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pessoas != null ? 
                          ...
                          Problem("Entity set 'MyDbContext.Pessoas'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Nasc")] Pessoa pessoa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Nasc")] Pessoa pessoa)
        {
            if (id != pessoa.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MyDbContext.Pessoas'  is null.");
            }
            var pessoa = await _context.Pessoas.FindAsync(id);
            if (pessoa != null)
            {
